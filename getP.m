...
function [x_as,y_as,z_as] = getP(x, y, z, p, scatt_mech, E_old, E_new)

  theta = getTheta(scatt_mech, E_old, E_new); % may have to change this based on scattering mechanism
  phi = getPhi();
