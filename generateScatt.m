...
function out = generateScatt()
  ...
  global GTot_X;
  global GTot_L;
  GTot_G = zeros(7, 1001, 1001);
  GTot_X = zeros(9, 1001, 1001);
  GTot_L = zeros(9, 1001, 1001);
  ...
  GTot_X_Max = max(max(GTot_X(9,:,:)));
  %GTot_X_Max = max(GTot_X, 'all');
