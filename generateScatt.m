...
function out = generateScatt()
  ...
  GTot_X(6,:) = G + Gpop_abs + Gpop_em + Giv_abs_XG + Giv_em_XG + Giv_abs_XL;
  GTot_X(7,:) = G + Gpop_abs + Gpop_em + Giv_abs_XG + Giv_em_XG + Giv_abs_XL + Giv_em_XL;
  GTot_X(8,:) = G + Gpop_abs + Gpop_em + Giv_abs_XG + Giv_em_XG + Giv_abs_XL + Giv_em_XL + Giv_abs_XX;
  GTot_X(9,:) = G + Gpop_abs + Gpop_em + Giv_abs_XG + Giv_em_XG + Giv_abs_XL + Giv_em_XL + Giv_abs_XX + Giv_em_XX;
  ...
  GTot_L(6,:) = G + Gpop_abs + Gpop_em + Giv_abs_LG + Giv_em_LG + Giv_abs_LL;
  GTot_L(7,:) = G + Gpop_abs + Gpop_em + Giv_abs_LG + Giv_em_LG + Giv_abs_LL + Giv_em_LL;
  GTot_L(8,:) = G + Gpop_abs + Gpop_em + Giv_abs_LG + Giv_em_LG + Giv_abs_LL + Giv_em_LL + Giv_abs_LX;
  GTot_L(9,:) = G + Gpop_abs + Gpop_em + Giv_abs_LG + Giv_em_LG + Giv_abs_LL + Giv_em_LL + Giv_abs_LX + Giv_em_LX;
