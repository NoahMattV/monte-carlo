...
Dac_G = 7.01*e; % Electron acoustic deformation potential (J) - Gamma
Dac_L = 9.2*e;
Dac_X = 9.0*e;
...
for i = 1:1001
  %changed m to be opposite of what I think it should be
%{
   gc3d_abs_GL(1,i) = 1/(2*pi^2) * (2*m/hbar^2)^(3/2) * real(sqrt(E(i) + E_GL - delta_E_LG));
   gc3d_em_GL(1,i) = 1/(2*pi^2) * (2*m/hbar^2)^(3/2) * real(sqrt(E(i) - E_GL - delta_E_LG));

   gc3d_abs_LG(1,i) = 1/(2*pi^2) * (2*mL/hbar^2)^(3/2) * real(sqrt(E(i) + E_GL + delta_E_LG));
   gc3d_em_LG(1,i) = 1/(2*pi^2) * (2*mL/hbar^2)^(3/2) * real(sqrt(E(i) - E_GL + delta_E_LG));

   gc3d_abs_GX(1,i) = 1/(2*pi^2) * (2*m/hbar^2)^(3/2) * real(sqrt(E(i) + E_GX - delta_E_XG));
   gc3d_em_GX(1,i) = 1/(2*pi^2) * (2*m/hbar^2)^(3/2) * real(sqrt(E(i) - E_GX - delta_E_XG));

   gc3d_abs_XG(1,i) = 1/(2*pi^2) * (2*mX/hbar^2)^(3/2) * real(sqrt(E(i) + E_GX + delta_E_XG));
   gc3d_em_XG(1,i) = 1/(2*pi^2) * (2*mX/hbar^2)^(3/2) * real(sqrt(E(i) - E_GX + delta_E_XG));

   gc3d_abs_LL(1,i) = 1/(2*pi^2) * (2*m/(hbar^2))^(3/2) * real(sqrt(E(i) + E_LL));
   gc3d_em_LL(1,i) = 1/(2*pi^2) * (2*m/(hbar^2))^(3/2) * real(sqrt(E(i) - E_LL));

   gc3d_abs_LX(1,i) = 1/(2*pi^2) * (2*mX/hbar^2)^(3/2) * real(sqrt(E(i) + E_LX - delta_E_XL));
   ...
   gc3d_em_XL(1,i) = 1/(2*pi^2) * (2*mL/hbar^2)^(3/2) * real(sqrt(E(i) + E_LX + delta_E_XL));

   gc3d_abs_XX(1,i) = 1/(2*pi^2) * (2*mX/hbar^2)^(3/2) * real(sqrt(E(i) + E_XX));
   gc3d_em_XX(1,i) = 1/(2*pi^2) * (2*mX/hbar^2)^(3/2) * real(sqrt(E(i) - E_XX));
%}
gc3d_abs_GL(1,i) = 1/(2*pi^2) * (2*mL/hbar^2)^(3/2) * real(sqrt(E(i) + E_GL - delta_E_LG));
gc3d_em_GL(1,i) = 1/(2*pi^2) * (2*mL/hbar^2)^(3/2) * real(sqrt(E(i) - E_GL - delta_E_LG));

gc3d_abs_LG(1,i) = 1/(2*pi^2) * (2*m/hbar^2)^(3/2) * real(sqrt(E(i) + E_GL + delta_E_LG));
gc3d_em_LG(1,i) = 1/(2*pi^2) * (2*m/hbar^2)^(3/2) * real(sqrt(E(i) - E_GL + delta_E_LG));

gc3d_abs_GX(1,i) = 1/(2*pi^2) * (2*mX/hbar^2)^(3/2) * real(sqrt(E(i) + E_GX - delta_E_XG));
gc3d_em_GX(1,i) = 1/(2*pi^2) * (2*mX/hbar^2)^(3/2) * real(sqrt(E(i) - E_GX - delta_E_XG));

gc3d_abs_XG(1,i) = 1/(2*pi^2) * (2*m/hbar^2)^(3/2) * real(sqrt(E(i) + E_GX + delta_E_XG));
gc3d_em_XG(1,i) = 1/(2*pi^2) * (2*m/hbar^2)^(3/2) * real(sqrt(E(i) - E_GX + delta_E_XG));
